...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdo Inscritos Mário" + devMario.getConteudosInscritos());
        devMario.progredir();
        System.out.println("-");
        System.out.println("Conteúdo Inscritos Mário" + devMario.getConteudosInscritos());
        System.out.println("Conteúdo Concluidos Mário" + devMario.getConteudosConcluidos());
